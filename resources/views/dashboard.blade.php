                                        ...
                                        <article 
                                            ...
                                            <div class="flex flex-col items-center gap-2 sm:col-span-2 lg:col-span-1">
                                                ...
                                                <button 
                                                    ...
                                                    <template x-if="esHoraDeSala(session.date_raw, session.time) && session.status.toLowerCase() !== 'finalizada' && session.status.toLowerCase() !== 'cancelada' && session.modalidad?.toLowerCase() !== 'presencial'">
                                        ...
                                        <article 
                                            ...
                                            <div class="flex flex-col items-center gap-2 sm:col-span-2 lg:col-span-1">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <template x-if="esHoraDeSala(reservation.date_raw, reservation.time) && reservation.status.toLowerCase() !== 'finalizada' && reservation.status.toLowerCase() !== 'cancelada' && reservation.modalidad?.toLowerCase() !== 'presencial'">
