                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">Consultoría IT y Desarrollo</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 space-y-4">
                        <div>
                            ...
                            <p class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">Centro de Asesoría IT</p>
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Descripción / Bio</label>
                            <p class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">lalala</p>
                        </div>
                    </div>
                </div>
            </div>
